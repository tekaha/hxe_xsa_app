sap.ui.define([
	...
	return BaseObject.extend("de.adwizor.xsa.model.GroupSortState", {
		 ...
		 * @alias de.adwizor.xsa.model.GroupSortState
		 */
		...
		group: function (sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "KUNNR");
			}
