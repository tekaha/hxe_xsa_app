sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("de/adwizor/xsa/app", ".html");
			sHash = sHash || "";
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#SAPHANAEXPRESSXSAApplication-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#SAPHANAEXPRESSXSAApplication-display";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("de.adwizor.xsa.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["de/adwizor/xsa/localService/mockserver"], function (mockserver) {
