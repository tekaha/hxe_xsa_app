				...
				assertions : {
					...
					theListHeaderDisplaysZeroHits : function () {
						return this.waitFor({
							viewName : sViewName,
							id : "page",
							matchers : new PropertyStrictEquals({name : "title", value : "Customer (0)"}),
							success : function () {
								Opa5.assert.ok(true, "The list header displays 'Customer (0)'");
							},
						...
						return this.waitFor({
							...
							success : function (oList) {
								...
								this.waitFor({
									id : "page",
									viewName : sViewName,
									matchers : new PropertyStrictEquals({name : "title", value : "Customer (" + iExpectedLength + ")"}),
									success : function () {
