sap.ui.define([
		"de/adwizor/xsa/model/GroupSortState",
	...
	QUnit.test("Should always return a sorter when sorting", function (assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("KUNNR").length, 1, "The sorting by KUNNR returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by KUNNR and there was a grouping before", function (assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "");

		this.oGroupSortState.sort("KUNNR");
