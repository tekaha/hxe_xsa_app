sap.ui.define([
		...
		return BaseObject.extend("de.adwizor.xsa.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias de.adwizor.xsa.model.ListSelector
			 */
			 ...
			 * @return {de.adwizor.xsa.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
